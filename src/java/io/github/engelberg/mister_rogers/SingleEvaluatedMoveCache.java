...
public class SingleEvaluatedMoveCache implements EvaluatedMoveCache {
    ...
    private Object evaluatedMove;
    private Object evaluation;
    
    // single cached move validation
    private Object validatedMove;
     ...
     */
    @Override
    public final void cacheMoveEvaluation(Object move, Object evaluation) {
        evaluatedMove = move;
     ...
     */
    @Override
    public final Object getCachedMoveEvaluation(Object move) {
        if(evaluatedMove == null || !(evaluatedMove == move)){
            // cache miss
            return null;
        } else {
            // cache hit
     ...
     */
    @Override
    public final void cacheMoveValidation(Object move, Object validation) {
        validatedMove = move;
     ...
     */
    @Override
    public final Object getCachedMoveValidation(Object move) {
        if(validatedMove == null || !(validatedMove == move)){
            // cache miss
            return null;
        } else {
            // cache hit
